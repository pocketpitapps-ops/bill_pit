...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'confirmedAmounts': PropertySchema(
      id: 3,
      name: r'confirmedAmounts',
      type: IsarType.doubleList,
    ),
    r'confirmedMonths': PropertySchema(
      id: 4,
      name: r'confirmedMonths',
    ...
    r'dueDay': PropertySchema(id: 6, name: r'dueDay', type: IsarType.long),
    ...
    r'isPaid': PropertySchema(id: 11, name: r'isPaid', type: IsarType.bool),
...
int _expenseEstimateSize(
  ...
  bytesCount += 3 + object.confirmedAmounts.length * 8;
  bytesCount += 3 + object.confirmedMonths.length * 8;
...
void _expenseSerialize(
  ...
  writer.writeDoubleList(offsets[3], object.confirmedAmounts);
  writer.writeLongList(offsets[4], object.confirmedMonths);
  writer.writeDateTime(offsets[5], object.createdAt);
  writer.writeLong(offsets[6], object.dueDay);
  writer.writeDateTime(offsets[7], object.endDate);
  writer.writeLong(offsets[8], object.frequency);
  writer.writeLong(offsets[9], object.installments);
  writer.writeBool(offsets[10], object.isActive);
  writer.writeBool(offsets[11], object.isPaid);
  writer.writeBool(offsets[12], object.isVariable);
  writer.writeString(offsets[13], object.name);
  writer.writeDateTime(offsets[14], object.paidDate);
  writer.writeLongList(offsets[15], object.paidMonths);
  writer.writeLong(offsets[16], object.reminderDays);
  writer.writeLongList(offsets[17], object.skippedMonths);
...
Expense _expenseDeserialize(
  ...
  object.confirmedAmounts = reader.readDoubleList(offsets[3]) ?? [];
  object.confirmedMonths = reader.readLongList(offsets[4]) ?? [];
  object.createdAt = reader.readDateTime(offsets[5]);
  object.dueDay = reader.readLongOrNull(offsets[6]);
  object.endDate = reader.readDateTimeOrNull(offsets[7]);
  object.frequency = reader.readLongOrNull(offsets[8]);
  object.id = id;
  object.installments = reader.readLongOrNull(offsets[9]);
  object.isActive = reader.readBool(offsets[10]);
  object.isPaid = reader.readBool(offsets[11]);
  object.isVariable = reader.readBool(offsets[12]);
  object.name = reader.readString(offsets[13]);
  object.paidDate = reader.readDateTimeOrNull(offsets[14]);
  object.paidMonths = reader.readLongList(offsets[15]) ?? [];
  object.reminderDays = reader.readLong(offsets[16]);
  object.skippedMonths = reader.readLongList(offsets[17]) ?? [];
  object.startDate = reader.readDateTimeOrNull(offsets[18]);
  object.type =
      _ExpensetypeValueEnumMap[reader.readByteOrNull(offsets[19])] ??
...
extension ExpenseQueryFilter
  ...
  confirmedAmountsElementEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsElementGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsElementLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsElementBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedAmounts', length, true, length, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedAmounts', 0, true, 0, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedAmounts', 0, false, 999999, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedAmounts', 0, true, length, include);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedAmountsLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'confirmedMonths', value: value),
      );
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsElementGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
          property: r'confirmedMonths',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsElementLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedMonths', length, true, length, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedMonths', 0, true, 0, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedMonths', 0, false, 999999, true);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'confirmedMonths', 0, true, length, include);
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
  confirmedMonthsLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'confirmedMonths',
        length,
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByConfirmedAmounts() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'confirmedAmounts');
    });
  }

  QueryBuilder<Expense, Expense, QDistinct> distinctByConfirmedMonths() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'confirmedMonths');
    });
  }
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, List<double>, QQueryOperations>
  confirmedAmountsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'confirmedAmounts');
    });
  }

  QueryBuilder<Expense, List<int>, QQueryOperations> confirmedMonthsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'confirmedMonths');
    });
  }
